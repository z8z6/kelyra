...
enum class TokenKind {
  ...
  asm_text,                 // raw inline assembly body
  keyword_let,              // let
  keyword_var,              // var
  keyword_fn,               // fn
  ...
  ast_asm_input,            // AST inline assembly input
  ast_asm_output,           // AST inline assembly output
  ast_asm_option,           // AST inline assembly option
